...
class _MainViewState extends State<MainView> {
  ...
  final List<double> _leftPosition = [30, 121, 211, 303.5];
  double _prevLeftPosition = -1;
  double _appBarIndicator = 30;
  @override
              ...
              child: Stack(
                children: [
                      ...
                      children: [
                        BottomNavBarItem(
                          ...
                          onTap: () {
                            ...
                            _appBarIndicator = _leftPosition[0];
                          },
                          width: 20,
                        ),
                        BottomNavBarItem(
                          ...
                          onTap: () {
                            ...
                            _appBarIndicator = _leftPosition[1];
                          },
                        ),
                        BottomNavBarItem(
                          ...
                          onTap: () async {
                            _prevLeftPosition =
                                _leftPosition[_controller.page!.toInt()];
                            setState(() {
                              _appBarIndicator = _leftPosition[2];
                            });
                            ...
                            showModalBottomSheet(
                              ...
                              setState(() {
                                _appBarIndicator = _prevLeftPosition;
                              });
                            });
                          },
                        ),
                        CustomShoppingCartIconButton(
                          onTap: () async {
                            _prevLeftPosition =
                                _leftPosition[_controller.page!.toInt()];
                            setState(() {
                              _appBarIndicator = _leftPosition[3];
                            });
                            await Future.delayed(
                              const Duration(milliseconds: 450),
                            );
                  ...
                  AnimatedPositioned(
                    ...
                    curve: Curves.easeInOut,
                    bottom: 10,
                    left: _appBarIndicator,
                    child: Container(width: 27, height: 3, color: Colors.black),
                  ),
                ],
              ),
            ),
